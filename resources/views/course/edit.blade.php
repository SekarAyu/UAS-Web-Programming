                ...
                <form action="{{ route('course.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input value="{{ $data->nama_course}}" type="text" id="nama_course" name="nama_course"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4"
                            ...
                            placeholder="Deskripsi course .......">{{ $data->deskripsi}}</textarea>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input value="{{ $data->price}}" type="number" id="price" name="price"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="mb-6">
                        <div>
                            <label for="gambar_course"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gambar
                                course</label>
                            @if ($data->gambar_course)
                            <figure class="max-w-lg mt-10 mx-auto mb-10">
                                <img class="h-auto max-w-full rounded-lg" src="{{ Storage::url($data->gambar_course) }}"
                                    alt="{{ $data->gambar_course}}">
                            </figure>
                            @else
                            <p class="mb-2">Tidak ada gambar</p>
                            @endif
                            <input type="file" id="gambar_course" name="gambar_course"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Gambar course" required>
